            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 20),
                  Text("Choose your account type", style: TextStyle(fontSize: 15, color: Colors.grey[700])),
                ],
              ),
              Column(
                children: <Widget>[
                  MaterialButton(
                    ...
                    child: Text("Driver", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 18)),
                  ),
                  SizedBox(height: 20),
                  MaterialButton(
                    minWidth: double.infinity,
                    ...
                    child: Text("User", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 18)),
                  ),
                ],
              ),
              Container(
